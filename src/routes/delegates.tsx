...
export const Route = createFileRoute("/delegates")({ component: DelegatesPage });
          ...
          {DELEGATE_FILES.map((d) => (
            ...
            >
              ...
              <p className="shrink-0 font-sans text-xs font-semibold tracking-[0.14em] text-foreground uppercase">
                {d.tax ? (
                  <a href={d.tax} className="hover:underline" target="_blank" rel="noreferrer">
                    Taxes
                  </a>
                ) : null}
                {d.tax && d.energy ? <span className="px-1.5 text-muted-foreground">|</span> : null}
                {d.energy ? (
                  <a href={d.energy} className="hover:underline" target="_blank" rel="noreferrer">
                    Energy
                  </a>
                ) : null}
              </p>
